...
import com.dy.mapper.FansMapper;
import com.dy.mapper.FansMapperCustom;
...
public class FansServiceImpl extends BaseInfoProperties implements FansService {
    ...
    public boolean queryDoIFollowVloger(String myId, String vlogerId) {
        //TODO 可优化查redis  关注时设置过redis.set(REDIS_FANS_AND_VLOGGER_RELATIONSHIP + ":" + myId + ":" + vlogerId, "1");
