...
//            httpProfile.setReqMethod("POST"); // 默认使用POST
            ...
            req.setSmsSdkAppId("1400907937");   // 短信应用ID: 短信SdkAppId在 [短信控制台] 添加应用后生成的实际SdkAppId
            req.setSignName("leo2021");         // 签名
            req.setTemplateId("2145582");       // 模板id：必须填写已审核通过的模板 ID。模板ID可登录 [短信控制台] 查看
